#!/usr/bin/env python3
"""
Career-Copilot: Generate specialized resumes for 为恒智能 and 振石控股.
"""
...
# ==========================================
# 1. 为恒智能 (ViHon) - AI Agent 工程师 (储能/双碳/虚拟电厂)
# ==========================================
data_vihon = {
...
# ==========================================
# 2. 振石控股集团 (Zhenshi) - 智能体研发工程师 / AI 应用模型开发
# ==========================================
data_zhenshi = {
    "basic_info": basic_info,
